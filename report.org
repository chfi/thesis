...
# TODO REF
This section will focus on automated or tool-assisted solutions;
reverse-engineering a system by hand is the most widely used solution,
# TODO REF
and are too general to describe here. In short, write tests to increase
the knowledge of the system, then perform changes to make it easier to
work with.

# **** Automated
Automated solutions mainly revolve around using various kinds of static
analysis to attempt to increase the knowledge of the codebase. One example
is breaking an entirely imperative codebase into OOP-style classes and
objects, by analyzing which functions and variables are used together.
# TODO REF
...
Tools can be simpler than breaking down the entire system into components,
by for example searching for duplicated code.

Another more general example is identifying reusable code
...
# Outro by hooking into how to prevent legacy code,
# or what are the coding practices that lead to legacy code (problems)
...
working with legacy codebases. This was done by extending BD and writing GGB blah blah.
...
programming project that was used, __ is introduced, followed by how
the hypothesis was evaluated in the context of this project.
...
Biodalliance (BD) is a HTML5 canvas-based genome browser written in JavaScript.
# TODO REF
# TODO its functions
# TODO its age & size
# TODO my earlier work on it
# TODO why we want something like it


*** Genetics Graph Browser
# TODO detail how the product was developed,
# and how it connects to & extends the BD legacy codebase

# TODO map the above FP features to overarching features in the product ?
...
The resulting browser fills the specified requirements, and the
...
** Did functional programming help?
...
# TODO FP encourages "better" code, but does not enforce it; however it often becomes more difficult to write bad than good code
# TODO tendency to become difficult to read; very terse, implicit information in types (need better docs)
